          ...
          <form action={updateEvent} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
              <div>
                ...
                <div className="mt-2">
                  <select name="category" id="category" defaultValue={event.category} className="block w-full rounded-2xl border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-[#EBE0F8] focus:ring-2 focus:ring-inset focus:ring-[#E5C1FA] sm:text-sm sm:leading-6">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input type="number" name="xp_value" id="xp_value" defaultValue={event.xp_value || 5} className="block w-full rounded-2xl border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#EBE0F8] focus:ring-2 focus:ring-inset focus:ring-[#E5C1FA] sm:text-sm sm:leading-6" />
                </div>
              </div>
